<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage(Admin).master" AutoEventWireup="true" CodeFile="Create_Shops.aspx.cs" Inherits="Admin_Create_Shops" %>
  ...
  <asp:TextBox ID="txtemail" type="email" placeholder="example@abc.com" cssclass="form-control" 
      required="required"  runat="server"></asp:TextBox><br />
        ...
        <div class="row">
            <div class="col-md-2">
            <strong>
                <asp:Label ID="LbUserName" runat="server" Text="User Name" CssClass="auto-style1"></asp:Label></strong></div>
                <div class="col-md-3" >
    <asp:TextBox ID="txtUName" cssclass="form-control"  runat="server" required="required"></asp:TextBox><br /></div>
       
            <div class="col-md-2">
            <strong>
                <asp:Label ID="lbpsswrd" runat="server" Text="Password" CssClass="auto-style1"></asp:Label>
            </strong></div>
                <div class="col-md-3" >
    <asp:TextBox ID="txtpsswrd" CssClass="form-control" TextMode="Password" 
        required="Password"  runat="server" ></asp:TextBox></div>   
     </div> 
  <div class="row">
            <div class="col-md-2"><strong>
                <asp:Label ID="lbShopName" runat="server" Text="Shop Name" CssClass="auto-style1"></asp:Label></strong></div>
                <div class="col-md-3" >
    <asp:TextBox ID="txtshopname" cssclass="form-control"  runat="server" required="required"></asp:TextBox><br /></div>
  
            <div class="col-md-2"><strong>
                <asp:Label ID="lbMAll" runat="server" Text="Select Mall" CssClass="auto-style1"></asp:Label></strong></div>
                <div class="col-md-3" >
                    <asp:DropDownList ID="ddlmalls" CssClass="form-control" required="required" runat="server">
        ...
        <div class="row">
            <div class="col-md-2"><strong>
                ...
                <div class="col-md-3" >
    <asp:TextBox ID="txtaddress" cssclass="form-control"  runat="server"></asp:TextBox><br /></div>
          
                <div class="col-md-2"><strong><asp:Label ID="lbImage" runat="server" Text="Image"
                     CssClass="auto-style1"></asp:Label></strong></div>
                <div class="col-md-3" >
                    <asp:FileUpload ID="FileUpload_shop" CssClass="btn btn-success btn-block1, form-control" runat="server" /><br />
            ...
            <div class="col-md-2"><strong>
                ...
                <div class="col-md-3" >
    <asp:TextBox ID="txtcontact" cssclass="form-control"    runat="server"></asp:TextBox><br /></div>
                
                  <div class="col-md-2"><strong>
                <asp:Label ID="lbCNIC" runat="server" Text="CNIC" CssClass="auto-style1"></asp:Label></strong></div>
                <div class="col-md-3" >
    <asp:TextBox ID="txtcnic" cssclass="form-control"    runat="server"></asp:TextBox><br /></div>
        </div> 
